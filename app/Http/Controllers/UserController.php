...
class UserController extends Controller{
    ...
    public function signUp(Request $request){
        ...
        $user->user_bio = "We know nothing about you :(";
        $user->save();
